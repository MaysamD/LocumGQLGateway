...
namespace LocumGQLGateway.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "categories",
                columns: new[] { "id", "created_by_id", "description", "is_deleted", "name", "slug", "sort_order", "updated_by_id" },
                values: new object[,]
                {
                    { 1, 1, "Basic personal details and identification info", false, "Personal Information", "personal-information", 1, null },
                    { 2, 1, "Information about your education background and training", false, "Education & Training", "education-training", 2, null },
                    { 3, 1, "All professional licenses and certifications", false, "Licenses & Certifications", "licenses-certifications", 3, null },
                    { 4, 1, "Details about your practice locations and affiliations", false, "Practice & Affiliation", "practice-affiliation", 4, null },
                    { 5, 1, "Previous work history and professional references", false, "Work History & References", "work-history-references", 5, null },
                    { 6, 1, "Claims history and disclosures", false, "Claims & Disclosures", "claims-disclosures", 6, null },
                    { 7, 1, "Health and legal background information", false, "Health & Legal History", "health-legal-history", 7, null }
                });
            ...
            migrationBuilder.InsertData(
                table: "form_category",
                columns: new[] { "category_id", "form_id" },
                values: new object[,]
                {
                    { 1, 1 },
                    { 2, 1 },
